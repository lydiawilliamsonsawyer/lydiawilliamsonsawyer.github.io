...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 15px; max-width: 1000px; margin: 40px auto;">
  <div style="display: flex; align-items: center; justify-content: center;">
    <img src="/assets/IMG_8872.jpeg" alt="Photo 3" style="max-width: 100%; height: auto; transform: rotate(270deg);">
  </div>
  <div style="display: flex; align-items: center; justify-content: center;">
    <img src="/assets/IMG_8870.jpeg" alt="Photo 2" style="max-width: 100%; height: auto;">
  </div>
  <div style="display: flex; align-items: center; justify-content: center;">
    <img src="/assets/IMG_8869.jpeg" alt="Photo 1" style="max-width: 100%; height: auto; transform: rotate(90deg);">
  </div>
  <div style="display: flex; align-items: center; justify-content: center;">
    <img src="/assets/IMG_8875.jpeg" alt="Photo 4" style="max-width: 100%; height: auto; transform: rotate(90deg);">
  </div>
</div>
